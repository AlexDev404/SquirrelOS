...
gcc -m32 -c kernel/lshell.c -o lshell.o -std=gnu99 -ffreestanding -w
...
gcc -m32 -c kernel/drivers/sound/pcspeaker/pcspeaker.c -o pcspeaker.o -std=gnu99 -ffreestanding -w
gcc -m32 -c kernel/drivers/timer/timer.c -o timer.o -std=gnu99 -ffreestanding -w

ld -m elf_i386 -T boot/linker.ld kernel.o screen.o utils.o keyboard.o ports.o lshell.o cpuid.o load_idt.o gdt.o idt.o isr.o vfs.o initrd.o serial.o panic.o pci.o rtc.o mouse.o pic.o ata.o fs.o acpi.o textedit.o math.o calculator.o serialapp.o slang.o tar.o printf.o pcspeaker.o timer.o boot.o load_gdt.o -o MyOS.bin -nostdlib --allow-multiple-definition
...
grub-mkrescue -o src/out/MyOS.iso isodir
